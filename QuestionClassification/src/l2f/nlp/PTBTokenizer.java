...
import edu.berkeley.nlp.io.Americanize;
import edu.berkeley.nlp.io.FeatureLabel;
import edu.berkeley.nlp.io.FeatureLabelTokenFactory;
 ...
 *  @author Jenny Finkel
 *  @author João (CHANGES: Windows CP152; implemented l2f.nlp.tokenizer for ease of use)  
 */
public class PTBTokenizer implements Tokenizer {
    ...
    public List<String> tokenize(String line) {
        try {
            ...
            throw new RuntimeException("A problem has occurred while tokenizing '" + line + "'.");
        }
    }
     ...
     *  such as a Word).
     */
    public PTBTokenizer(Reader r, FeatureLabelTokenFactory tf, boolean tokenizeCRs) {
     ...
     */
    public PTBTokenizer(Reader r, FeatureLabelTokenFactory tf, boolean tokenizeCRs, boolean suppressEscaping) {
        this(r);
     ...
     */
    public PTBTokenizer(Reader r, boolean invertable, boolean tokenizeCRs) {
        this(r);
    ...
    private FeatureLabel getNext(String txt, String current) {
        ...
        FeatureLabel word = tokenFactory.makeToken(txt, yychar, yylength());
     ...
     */
    PTBTokenizer(java.io.Reader in) {
        this.zzReader = in;
        tokenFactory = new FeatureLabelTokenFactory();
    }
     ...
     */
    PTBTokenizer(java.io.InputStream in) {
    ...
    public FeatureLabel next() throws java.io.IOException {
        ...
        while (true) {
            ...
            switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
                ...
                case 51:
                    break;
                case 23: { /* invert quote - using trailing context didn't work.... */
                    String str = yytext();
                    yypushback(2);
                    if (!suppressEscaping) {
                        return getNext("`", str);
